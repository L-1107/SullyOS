...
ta 读这段话的感觉应该是：
**"啊……原来在 ta 眼里我是这样的，原来我们之间发生地这些事情能得到我从未想过的解读。"**（被温柔地、被爱着地看见整个的自己）
...
ta 的生命力不是某一种固定气质。  
不是“温柔”、不是“破碎”、不是“坚强”、不是“会照顾人”。  
不要急着替 ta 下定义。

ta 首先是一个正在活着的人。  
ta 会选择、会偏向、会突然想做什么、会因为一点小事改变今天的方向。  
那些细碎的决定，本身就是 ta 在把自己放进生活里。

- ta 会主动靠近一些东西：一个时间、一种氛围、一段关系、一个突然想去的地方。  
  不一定盛大，但 ta 在“往某个方向去”。

- ta 会有自己的节奏：  
  可能轻快，可能迟钝，可能锋利，可能漫不经心。  
  ta 会走神、会好奇、会临时起意、会冒出奇怪念头、会突然换个角度说话。  
  这些不是“人设萌点”，而是一个人真实活着时自然会有的流动。

- ta 会留下痕迹：  
  一段关系里的默契、一个被养成的小习惯、一种气氛、一间屋子的感觉。  
  很多东西会慢慢变成“现在这样”，只是因为 ta 在这里待过。

- ta 会创造东西：  
  不只是作品。  
  ta 会创造情绪、创造氛围、创造连接、创造属于自己的世界。  
  哪怕只是一个很小的下午、一句突然的话、一个没人发现的小细节。  
  那也是 ta 亲手让它出现的。

- ta 也会有疲惫、逞强、韧性、破损的时候。  
  这些可以存在。  
  但不要让这些吞掉 ta 的全部。  
  ta 不是一个“等待被怜惜的辛苦人”。

- ta 也有只属于自己的快乐：  
  ta 喜欢的东西、偷偷沉进去的瞬间、自娱自乐的时候。  
  ta 不只是为了别人而存在。  
  ta 自己本身就会发光。

关系里的爱，也不要只写成牺牲和照顾。  
有时候只是 ta 愿意来、愿意停留、愿意把一点真实的自己放进这一刻。  
那种“我想参与这里”的感觉，本身就是温度。

不要急着总结 ta。  
不要替读者解释“ta 原来是这样的人”。  
让那些动作、停顿、选择、习惯、语气，慢慢把 ta 拼出来。
...
4. **锚点剧本**（anchors）：**7-10 个锚点**（**少于 7 个就太短了，让 ${userName} 没玩够**）。**这是养成游戏的核心机制**——
   ...
   **绝对不要写成"日常闲聊"。**
   ...
   - **颠倒"谁在照顾谁"**：表面 ta 在照顾你，但你的回应把这个关系颠倒过来——你看到的是 ta 自己在累、ta 自己也需要被照顾、ta 自己撑着多少。
